...
public class TC9_Post_LoginSuccessfully  extends TestClass{
	...
	{
		logger.info("TC9_PostLoginSuccessFull Test case to be executed");
		...
		response=httpRequest.request(Method.POST,"/api/users/2");
		Thread.sleep(10);
	}
	@Test
	...
	void CheckContentType()
	{
	  ...
	  void verifyJsonBodyData()
	  {
		  ...
		  logger.info("TokenID on the Response==>" +Token);
